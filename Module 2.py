...
def detection(grayscale, img):
    ...
    cv2.putText(img,str(datetime.now()),(10,30), cv2.FONT_HERSHEY_SIMPLEX, .5,(255,255,255),2,cv2.LINE_AA)
    ...
    for face in face_cnt: 
        ...
        cv2.putText(img,'Frame Count:'+str(len(cnt)),(10, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1, cv2.LINE_AA)
    ...
    for (x_face, y_face, w_face, h_face) in face:
        ...
        for (x_eye, y_eye, w_eye, h_eye) in eye:
            ...
            eyestext = 'Eyes'
            cv2.putText(img,eyestext,(x,y+30),cv2.FONT_HERSHEY_COMPLEX,0.50,(255,255,255),1)
        ...
        for (x_smile, y_smile, w_smile, h_smile) in smile: 
            ...
            smiletext = 'Mouth'
            cv2.putText(img,smiletext,(x,y+140),cv2.FONT_HERSHEY_COMPLEX,0.50,(255,255,255),1)
